...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "cwstorm-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/cwstorm_inc"
  #   chef.validation_client_name = "cwstorm_inc-validator"
  #   chef.validation_key_path = ".chef/cwstorm_inc-validator.pem"
  # end
end
